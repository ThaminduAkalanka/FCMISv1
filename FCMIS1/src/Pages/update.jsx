...
const frontStyles = {
  card: `backface-hidden absolute h-full w-full space-y-4  rounded-lg   bg-neutral-800 px-6 py-12 shadow-xl`,
  date: `inline-block rounded-2xl border border-gray-100 px-2 py-1 text-xs font-medium text-gray-100`,
};

const backStyles = {
  card: `backface-hidden absolute h-full w-full space-y-4 rounded-lg  overflow-hidden bg-cover px-6 py-12 shadow-xl`,
...
const ViewAnnouncement = () => {
  ...
  return (
    <main class='bg-white'>
      ...
      <div className="grid gap-10 xl:grid-cols-2 3xl:grid-cols-2 p-20">
      {/* 01 */}
      ...
      <div className="perspective group h-72">
        <div className={`${cardStyles} group-hover:rotate-y-180`}>
          ...
          <div className={frontStyles.card}>
            ...
            <h4 className="font-bold text-lg">{announcement.announcement}</h4>
