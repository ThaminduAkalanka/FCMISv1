...
const Report = () => {
  ...
  const handleAttendanceReportSubmit = async (event) => {
    ...
    try {
      ...
      navigate('/dashboard/attendancereport', { state: { report: response.data, startDate, endDate } });
    } catch (error) {
  ...
  const handleIncomeReportSubmit = async () => {
    try {
      ...
      navigate('/dashboard/incomereport', { state: { report: response.data, startDate, endDate } });
    } catch (error) {
