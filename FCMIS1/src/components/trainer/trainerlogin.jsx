...
const trainerLogin = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:3000/train/trainerlogin', values)
            .then(result => {
    ...
    return (
        <div className='relative flex flex-col md:flex-row justify-evenly items-center h-screen p-20 sm:p-10'>
            <div className='absolute top-8 right-8 flex space-x-4'>
                ...
                <Link to="/memberlogin" className="text-sm text-white hover:text-blue-100">Member Login</Link>
            </div>
            <div>
            <div className='flex justify-left font-bold text-xl pb-6 space-x-2 mt-8'>
                    <p class='text-yellow-600'>Trainer</p> <p>Login</p>
                </div>
